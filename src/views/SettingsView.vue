...
<style scoped>
/* Main Layout */
/* No `grid-column` and no `overflow-y` - App.vue handles that */
.main {
...
.btn-primary   { margin-left: var(--space-6); }
.btn-secondary { margin-left: var(--space-1); }
...
/* Danger Zone */
/* Add bottom padding to the settings card */
.danger-zone {
    margin-top: var(--space-6);
    margin-left: var(--space-6);
