...
<template>
  <div class="profile-wrapper">
    ...
    <div class="profile-hero">
      ...
      <div class="hero-info">
        {{ profile.displayName || $t("profile.placeholder_name") }}
        <p class="hero-role">
          {{ profile.role || $t("profile.placeholder_role") }}
        </p>
    ...
    <div v-if="profile.bio" class="profile-card">
      <h2 class="card-title">{{ $t("profile.about") }}</h2>
      <p class="bio-text">{{ profile.bio }}</p>
    </div>

    <!-- Contact -->
    <div class="profile-card">
      <h2 class="card-title">{{ $t("profile.contact") }}</h2>
      <div class="contact-grid">
        ...
        >
          ...
          <div class="contact-info">
            <span class="contact-label">{{ $t("profile.fields.email") }}</span>
        ...
        >
          ...
          <div class="contact-info">
            <span class="contact-label">{{ $t("profile.fields.phone") }}</span>
        ...
        >
          <div class="modal">
            <header class="modal-header">
              <h2 class="modal-title">{{ $t("profile.edit_btn") }}</h2>
            ...
            <div class="modal-body">
              ...
              <div class="field-row">
                ...
                <div class="field">
                  ...
                  <select v-model="form.status" class="form-input form-select">
                    <option value="">{{ $t("profile.status.none") }}</option>
              ...
              <div class="field">
                <label class="field-label">{{ $t('profile.fields.bio') }}</label>
                <textarea
                  v-model="form.bio"
              ...
              <div class="field">
                <label class="field-label">{{ $t('profile.fields.email') }}</label>
                <input
                  v-model="form.email"
                  class="form-input"
                  type="email"
              ...
              <div class="field-row">
                <div class="field">
                  <label class="field-label">{{ $t('profile.fields.phone') }}</label>
                  <input
                    v-model="form.phone"
                    class="form-input"
                    type="tel"
                ...
                <div class="field">
                  <label class="field-label">{{ $t('profile.fields.website') }}</label>
                  <input
              ...
              <div class="field">
                <label class="field-label">{{ $t('profile.fields.github') }}</label>
                <input
                  v-model="form.github"
                  class="form-input"
                  type="text"
              ...
              <div class="field">
                <label class="field-label">{{ $t('profile.skills') }}</label>
                <div class="tag-input-wrapper">
                  ...
                  >
                    {{ skill }}
                    <button class="tag-remove" @click="removeSkill(skill)">
                      ×
                    </button>
                  </span>
                  <input
            ...
            <footer class="modal-footer">
              ...
              <button class="btn btn-primary" @click="saveModal">{{ $t('common.save') }}</button>
            </footer>
          </div>
        </div>
      </Transition>
...
function removeSkill(skill) {
  form.skills = form.skills.filter((sk) => sk !== skill);
}
</script>
...
.contact-item:hover {
  ...
  background: color-mix(
    ...
    var(--color-surface-hover, #252840)
  );
}
